...
if(isset($_POST['submit'])){
  ...
  $cek_usn = ambilData("SELECT * FROM account WHERE username = '$username'");
  if(!empty($cek_usn)){
  ...
  if(registrasiAkun($_POST) > 0){
    ...
    <span class="font-medium">Akun berhasil dibuat silakan login</span> </div>';
...
<?php } ?>
        ...
        <label class="font-semibold text-sm text-black pb-1 block" require>Name</label>
          ...
          <input type="email" name="email" require class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />

          <label class="font-semibold text-sm text-black pb-1 block">Username</label>
          <input type="text" name="username" require class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
          <label class="font-semibold text-sm text-black pb-1 block">Password</label>
          <input type="text" name="password" require class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" />
